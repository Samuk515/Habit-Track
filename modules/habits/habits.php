  ...
  <div class="app-layout">
    ...
    <div class="main-content">
      ...
      <div style="display:flex;gap:24px;align-items:flex-start;flex-wrap:wrap;">
        ...
        <?php if (empty($habits)): ?>
          <div class="empty-state" style="flex:1;"><p>No habits yet.</p></div>
        <?php else: ?>
          <div style="flex:1;min-width:280px;display:flex;flex-direction:column;gap:10px;">
            <?php foreach ($habits as $h): ?>
              <div class="auth-card" style="padding:16px 20px;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:10px;">
                <div>
